class ZRAPLG_CL_VH_PRODUCT_LGL definition
  public
  final
  create public .
...
public section.
  ...
  types:
    T_PRODUCTS TYPE STANDARD TABLE OF ZLGEXT01_VH_PRODUCT_LGL WITH  EMPTY KEY .
...
CLASS ZRAPLG_CL_VH_PRODUCT_LGL IMPLEMENTATION.
...
METHOD IF_RAP_QUERY_PROVIDER~SELECT.
  DATA business_data TYPE TABLE OF ZLGEXT01_VH_Product_LGL.
  DATA business_data_line TYPE ZLGEXT01_VH_Product_LGL .
